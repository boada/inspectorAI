...
name_space = app.namespace(
    'apis', description='APIs assciated with restaurant predictions')
...
class MainClass(Resource):
    @app.doc(responses={
        ...
        500: 'Mapping Key Error'
             ...
             params={
                 'start_date': 'Starting date for the prediction window',
    ...
    def load_model(self):
        ...
        try:
            ...
            name_space.abort(500,
                             e.__doc__,
                             status="Could not retrieve model information",
                             statusCode="500")
    ...
    def load_catalogs(self, start_date, end_date, FEATURES=FEATURES):
        ...
        for feat in CAT_FEATURES:
            try:
                new_df = pd.concat(
                    [new_df, pd.get_dummies(inspecs[feat])], axis=1)
            except NameError:
